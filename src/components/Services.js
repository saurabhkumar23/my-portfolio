    ...
    return (
        <section id='services' className='py-5 bg-light'>
            <div className='container py-5'>
                <h1 className='first-heading text-center pb-3' data-aos='zoom-in'>SERVICES</h1>
                <h1 className='second-heading text-center pb-5' data-aos='zoom-in'>What Can I Do For You?</h1>                
                <div className='row justify-content-evenly pb-3' data-aos='zoom-in'>
